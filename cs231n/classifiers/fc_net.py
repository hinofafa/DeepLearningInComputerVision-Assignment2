...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_scores = affine_forward(a, W2,
                                              b2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
